...
class ChatModel:
    ...
    def _process_args(
        ...
        **input_kwargs
        ...
        text = self.tokenizer.decode(prompt, skip_special_tokens=True, clean_up_tokenization_spaces=True)
        # print(f"\n\n======Model Input=======\n\n{text}\n\n======Model Output=======\n")
    ...
    def stream_chat(
        ...
        **input_kwargs
        ...
        # print(gen_kwargs)
        prompt = self.tokenizer.decode(gen_kwargs["inputs"][0], skip_special_tokens=False, clean_up_tokenization_spaces=False)
        # print("prompt:", prompt)
