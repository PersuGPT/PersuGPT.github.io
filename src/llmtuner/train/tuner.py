...
from llmtuner.train.sft import run_sft, run_sft_m2t
...
def run_exp(args: Optional[Dict[str, Any]] = None, callbacks: Optional[List["TrainerCallback"]] = None):
    ...
    elif finetuning_args.stage == "sft_m2t":
        run_sft_m2t(model_args, data_args, training_args, finetuning_args, generating_args, callbacks)
