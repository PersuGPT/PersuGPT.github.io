...
def add_motion_tokens(tokenizer):
    new_tokens = [f"motion_{i}" for i in range(2048)]
...
def load_model_and_tokenizer(
    ...
    if model is None:
        ...
        for name, param in model.named_parameters():
            print("name:", name)
        # print("emb:", model.model.embed_tokens.weight.size())
        # print(model.model.embed_tokens.weight[-2048:,:])
